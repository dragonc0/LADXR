...
class Dungeon3:
    def __init__(self):
        ...
        Location(3).add(DroppedKey(0x155)).connect(area_down, attack_no_boomerang)
        ...
        Location(3).add(DroppedKey(0x148)).connect(area_right, attack_no_boomerang)
        ...
        pre_boss = Location(3).connect(towards_boss4, AND(attack_no_boomerang, PEGASUS_BOOTS))
