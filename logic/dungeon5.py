...
class Dungeon5:
    def __init__(self, options, world_setup):
        ...
        if  options.logic == 'hell':
            ...
            after_keyblock_boss.connect(after_stalfos, AND(PEGASUS_BOOTS, attack_hookshot_powder), one_way=True) # pit buffer from after keyblock to bottom left, boots bonk across 2d bridge
            if butterfly_owl:
